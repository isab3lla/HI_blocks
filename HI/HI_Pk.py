...
f_out = 'HI_Pk_'+sim[:-6]+'_z'+z_str[isnap]+'_'+str(Np_halo)+'pHalo_CR15.dat'
...
print len(IDs_g), len(M_HI), Ntotal

#compute the value of Omega_HI
Omega_HI=np.sum(M_HI,dtype=np.float64)/BoxSize**3/rho_crit
print '\nOmega_HI (ricalculated) = %e'%Omega_HI
print 'and should be -->         %e'%OmegaHI
